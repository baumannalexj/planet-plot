...
<<<<<<< HEAD
* task-wi-26-svg-fieldline-arrows | WORK_ITEM_TASKS/task-wi-26-svg-fieldline-arrows.md | status: READY_FOR_MERGE: worktree-agent-aa55ba8924515bb11
=======
* task-wi-26-svg-fieldline-arrows | WORK_ITEM_TASKS/task-wi-26-svg-fieldline-arrows.md | status: TODO
>>>>>>> 107817d (docs(WORK_QUEUE): mark Task 28 ready for merge)
* task-wi-28-provider-di-viewcontroller | WORK_ITEM_TASKS/task-wi-28-provider-di-viewcontroller.md | status: READY_FOR_MERGE: task-wi-28-provider-di-viewcontroller
...
* task-wi-31-jacobi-potential | WORK_ITEM_TASKS/archive/task-wi-31-jacobi-potential.md | status: DONE
...
* task-wi-34-svg-arrow-icon | WORK_ITEM_TASKS/task-wi-34-svg-arrow-icon.md | status: READY_FOR_MERGE: worktree-agent-a9be6d1e65b6cf904
